...
classifier = cv2.CascadeClassifier(r'C:/Users/Shalini/Desktop/Face Detection/Face Detection/haarcascade_frontalface_default.xml')

model = load_model(r'C:/Users/Shalini/Desktop/Face Detection/Face Detection/final_model.h5')

URL = 'http://192.168.33.78:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Shalini Behera']
    return labels[pred]
